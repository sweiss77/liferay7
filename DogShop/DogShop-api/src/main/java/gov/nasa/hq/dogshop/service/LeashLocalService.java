...
/**
 * Provides the local service interface for Leash. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LeashLocalServiceUtil
...
public interface LeashLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link LeashLocalServiceUtil} to access the leash local service. Add custom service methods to {@link gov.nasa.hq.dogshop.service.impl.LeashLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Leash addLeash(User user, java.lang.String color, int length,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Leash fetchLeashByUuidAndGroupId(java.lang.String uuid, long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Leash getLeashByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<Leash> getLeashsByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
