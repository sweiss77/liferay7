...
public class AudiModelImpl extends BaseModelImpl<Audi> implements AudiModel {
	...
	public static Audi toModel(AudiSoap soapModel) {
		...
		model.setAllWheelDrive(soapModel.getAllWheelDrive());
		model.setTechnologyPackage(soapModel.getTechnologyPackage());
		model.setColdWeatherPackage(soapModel.getColdWeatherPackage());
	...
	public Object clone() {
		...
		audiImpl.setAllWheelDrive(getAllWheelDrive());
		audiImpl.setTechnologyPackage(getTechnologyPackage());
		audiImpl.setColdWeatherPackage(getColdWeatherPackage());
	...
	public CacheModel<Audi> toCacheModel() {
		...
		audiCacheModel.allWheelDrive = getAllWheelDrive();

		audiCacheModel.technologyPackage = getTechnologyPackage();

		audiCacheModel.coldWeatherPackage = getColdWeatherPackage();
	...
	public String toString() {
		...
		sb.append(getAllWheelDrive());
		sb.append(", technologyPackage=");
		sb.append(getTechnologyPackage());
		sb.append(", coldWeatherPackage=");
		sb.append(getColdWeatherPackage());
		sb.append("}");
