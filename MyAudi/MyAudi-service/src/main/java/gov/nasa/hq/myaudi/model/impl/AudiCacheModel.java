...
public class AudiCacheModel implements CacheModel<Audi>, Externalizable {
	...
	public Audi toEntityModel() {
		...
		if (uuid == null) {
			audiImpl.setUuid(StringPool.BLANK);
		}
		else {
		...
		if (userName == null) {
			audiImpl.setUserName(StringPool.BLANK);
		}
		else {
		...
		if (modelName == null) {
			audiImpl.setModelName(StringPool.BLANK);
		}
		else {
		...
		if (exteriorColor == null) {
			audiImpl.setExteriorColor(StringPool.BLANK);
		}
		else {
		...
		if (interiorColor == null) {
			audiImpl.setInteriorColor(StringPool.BLANK);
		}
		else {
