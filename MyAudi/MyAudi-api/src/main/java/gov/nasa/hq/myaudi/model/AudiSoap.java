...
public class AudiSoap implements Serializable {
	public static AudiSoap toSoapModel(Audi model) {
		...
		soapModel.setAllWheelDrive(model.getAllWheelDrive());
		soapModel.setTechnologyPackage(model.getTechnologyPackage());
		soapModel.setColdWeatherPackage(model.getColdWeatherPackage());
