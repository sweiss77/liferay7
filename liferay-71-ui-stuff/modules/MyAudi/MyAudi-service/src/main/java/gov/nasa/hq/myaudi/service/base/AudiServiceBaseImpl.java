...
import gov.nasa.hq.myaudi.service.AudiService;
import gov.nasa.hq.myaudi.service.persistence.AudiPersistence;

/**
 * Provides the base implementation for the audi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder.
 * All custom service methods should be put in {@link gov.nasa.hq.myaudi.service.impl.AudiServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class AudiServiceBaseImpl extends BaseServiceImpl implements AudiService, IdentifiableOSGiService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link
     * gov.nasa.hq.myaudi.service.AudiServiceUtil} to access the audi remote service.
     */
     ...
     */
    public gov.nasa.hq.myaudi.service.AudiLocalService getAudiLocalService() {
     ...
     */
    public void setAudiLocalService(gov.nasa.hq.myaudi.service.AudiLocalService audiLocalService) {
        this.audiLocalService = audiLocalService;
    }

    /**
     * Returns the audi remote service.
     *
     * @return the audi remote service
     */
    ...
    /**
     * Sets the audi remote service.
     *
     * @param audiService
     *            the audi remote service
     */
    ...
    public String getOSGiServiceIdentifier() {
        return AudiService.class.getName();
    }
    ...
    @BeanReference(type = gov.nasa.hq.myaudi.service.AudiLocalService.class)
    protected gov.nasa.hq.myaudi.service.AudiLocalService audiLocalService;
    @BeanReference(type = AudiService.class)
    protected AudiService audiService;
