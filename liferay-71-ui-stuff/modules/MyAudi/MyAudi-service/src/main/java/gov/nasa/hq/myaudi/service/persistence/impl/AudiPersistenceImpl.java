 ...
 */
@ProviderType
public class AudiPersistenceImpl extends BasePersistenceImpl<Audi>
	implements AudiPersistence {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link AudiUtil} to access the audi persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid",
			new String[] { String.class.getName() },
			AudiModelImpl.UUID_COLUMN_BITMASK |
	...
	public List<Audi> findByUuid(String uuid, int start, int end,
		...
		if (retrieveFromCache) {
			list = (List<Audi>)finderCache.getResult(finderPath, finderArgs,
					this);
		...
		if (list == null) {
			...
			try {
				...
				if (!pagination) {
					list = (List<Audi>)QueryUtil.list(q, getDialect(), start,
							end, false);
	 ...
	 */
	@Override
	public Audi findByUuid_First(String uuid,
	 ...
	 */
	@Override
	public Audi fetchByUuid_First(String uuid,
		OrderByComparator<Audi> orderByComparator) {
	 ...
	 */
	@Override
	public Audi findByUuid_Last(String uuid,
		OrderByComparator<Audi> orderByComparator) throws NoSuchAudiException {
	 ...
	 */
	@Override
	public Audi fetchByUuid_Last(String uuid,
		OrderByComparator<Audi> orderByComparator) {
	...
	public Audi[] findByUuid_PrevAndNext(long audiId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(session, audi, uuid,
					orderByComparator, true);

			array[1] = audi;

			array[2] = getByUuid_PrevAndNext(session, audi, uuid,
	...
	protected Audi getByUuid_PrevAndNext(Session session, Audi audi,
		String uuid, OrderByComparator<Audi> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid(String uuid) {
		for (Audi audi : findByUuid(uuid, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
				null)) {
			remove(audi);
		}
	}
	...
	public static final FinderPath FINDER_PATH_FETCH_BY_UUID_G = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			...
			AudiModelImpl.UUID_COLUMN_BITMASK |
			AudiModelImpl.GROUPID_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public Audi findByUUID_G(String uuid, long groupId)
	...
	public Audi fetchByUUID_G(String uuid, long groupId,
		...
		if (result instanceof Audi) {
			...
			if (!Objects.equals(uuid, audi.getUuid()) ||
					(groupId != audi.getGroupId())) {
				result = null;
			}
		}
	 ...
	 */
	@Override
	public Audi removeByUUID_G(String uuid, long groupId)
		throws NoSuchAudiException {
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_UUID_C = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID_C =
		new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUuid_C",
			new String[] { String.class.getName(), Long.class.getName() },
			AudiModelImpl.UUID_COLUMN_BITMASK |
			AudiModelImpl.COMPANYID_COLUMN_BITMASK |
			AudiModelImpl.EXTERIORCOLOR_COLUMN_BITMASK);
	 ...
	 */
	@Override
	public List<Audi> findByUuid_C(String uuid, long companyId, int start,
		int end) {
	...
	public Audi fetchByUuid_C_Last(String uuid, long companyId,
		...
		List<Audi> list = findByUuid_C(uuid, companyId, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Audi[] findByUuid_C_PrevAndNext(long audiId, String uuid,
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(session, audi, uuid, companyId,
					orderByComparator, true);

			array[1] = audi;

			array[2] = getByUuid_C_PrevAndNext(session, audi, uuid, companyId,
					orderByComparator, false);
	...
	protected Audi getByUuid_C_PrevAndNext(Session session, Audi audi,
		String uuid, long companyId, OrderByComparator<Audi> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByUuid_C(String uuid, long companyId) {
		for (Audi audi : findByUuid_C(uuid, companyId, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(audi);
		}
	}
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MODELNAME =
		new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			...
			new String[] { String.class.getName() },
			AudiModelImpl.MODELNAME_COLUMN_BITMASK |
			AudiModelImpl.EXTERIORCOLOR_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_MODELNAME = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countBymodelName",
			new String[] { String.class.getName() });

	/**
	 * Returns all the audis where modelName = &#63;.
	 *
	 * @param modelName the model name
	 * @return the matching audis
	 */
	@Override
	public List<Audi> findBymodelName(String modelName) {
		return findBymodelName(modelName, QueryUtil.ALL_POS, QueryUtil.ALL_POS,
			null);
	}

	/**
	 * Returns a range of all the audis where modelName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link AudiModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	 ...
	 */
	@Override
	public List<Audi> findBymodelName(String modelName, int start, int end) {
		return findBymodelName(modelName, start, end, null);
	}

	/**
	 * Returns an ordered range of all the audis where modelName = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link QueryUtil#ALL_POS} will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code> and <code>end</code> are not {@link QueryUtil#ALL_POS}), then the query will include the default ORDER BY logic from {@link AudiModelImpl}. If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an ascending order.
	 * </p>
	...
	public List<Audi> findBymodelName(String modelName, int start, int end,
		OrderByComparator<Audi> orderByComparator) {
		return findBymodelName(modelName, start, end, orderByComparator, true);
	}
	...
	public List<Audi> findBymodelName(String modelName, int start, int end,
		...
		if (retrieveFromCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (Audi audi : list) {
					if (!modelName.equals(audi.getModelName())) {
						list = null;
	...
	/**
	 * Returns the first audi in the ordered set where modelName = &#63;.
	 *
	 * @param modelName the model name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the first matching audi
	 ...
	 */
	@Override
	public Audi findBymodelName_First(String modelName,
		OrderByComparator<Audi> orderByComparator) throws NoSuchAudiException {
		Audi audi = fetchBymodelName_First(modelName, orderByComparator);
	 ...
	 */
	@Override
	public Audi fetchBymodelName_First(String modelName,
		OrderByComparator<Audi> orderByComparator) {
		List<Audi> list = findBymodelName(modelName, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last audi in the ordered set where modelName = &#63;.
	 *
	 * @param modelName the model name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 * @return the last matching audi
	 ...
	 */
	@Override
	public Audi findBymodelName_Last(String modelName,
		OrderByComparator<Audi> orderByComparator) throws NoSuchAudiException {
		Audi audi = fetchBymodelName_Last(modelName, orderByComparator);
	 ...
	 */
	@Override
	public Audi fetchBymodelName_Last(String modelName,
		OrderByComparator<Audi> orderByComparator) {
		...
		List<Audi> list = findBymodelName(modelName, count - 1, count,
				orderByComparator);
	...
	/**
	 * Returns the audis before and after the current audi in the ordered set where modelName = &#63;.
	 *
	 * @param audiId the primary key of the current audi
	 * @param modelName the model name
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public Audi[] findBymodelName_PrevAndNext(long audiId, String modelName,
		OrderByComparator<Audi> orderByComparator) throws NoSuchAudiException {
		modelName = Objects.toString(modelName, "");
		...
		try {
			...
			array[0] = getBymodelName_PrevAndNext(session, audi, modelName,
					orderByComparator, true);

			array[1] = audi;

			array[2] = getBymodelName_PrevAndNext(session, audi, modelName,
					orderByComparator, false);
	...
	protected Audi getBymodelName_PrevAndNext(Session session, Audi audi,
		String modelName, OrderByComparator<Audi> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	/**
	 * Removes all the audis where modelName = &#63; from the database.
	 *
	 * @param modelName the model name
	 */
	@Override
	public void removeBymodelName(String modelName) {
		for (Audi audi : findBymodelName(modelName, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(audi);
		}
	}
	...
	/**
	 * Returns the number of audis where modelName = &#63;.
	 *
	 * @param modelName the model name
	 * @return the number of matching audis
	 */
	...
	private static final String _FINDER_COLUMN_MODELNAME_MODELNAME_1 = "audi.modelName IS NULL";
	private static final String _FINDER_COLUMN_MODELNAME_MODELNAME_2 = "audi.modelName = ?";
	private static final String _FINDER_COLUMN_MODELNAME_MODELNAME_3 = "(audi.modelName IS NULL OR audi.modelName = '')";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_EXTERIORCOLOR =
		new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByexteriorColor",
			new String[] {
				String.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_EXTERIORCOLOR =
		new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, AudiImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByexteriorColor",
			new String[] { String.class.getName() },
			AudiModelImpl.EXTERIORCOLOR_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_EXTERIORCOLOR = new FinderPath(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByexteriorColor",
			new String[] { String.class.getName() });
	...
	public List<Audi> findByexteriorColor(String exteriorColor) {
		return findByexteriorColor(exteriorColor, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Audi> findByexteriorColor(String exteriorColor, int start,
		int end) {
	...
	public List<Audi> findByexteriorColor(String exteriorColor, int start,
		int end, OrderByComparator<Audi> orderByComparator) {
		return findByexteriorColor(exteriorColor, start, end,
			orderByComparator, true);
	}
	...
	public List<Audi> findByexteriorColor(String exteriorColor, int start,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			finderArgs = new Object[] { exteriorColor };
		}
		else {
	...
	public Audi fetchByexteriorColor_First(String exteriorColor,
		OrderByComparator<Audi> orderByComparator) {
		List<Audi> list = findByexteriorColor(exteriorColor, 0, 1,
				orderByComparator);
	...
	public Audi fetchByexteriorColor_Last(String exteriorColor,
		...
		List<Audi> list = findByexteriorColor(exteriorColor, count - 1, count,
				orderByComparator);
	 ...
	 */
	@Override
	public Audi[] findByexteriorColor_PrevAndNext(long audiId,
		String exteriorColor, OrderByComparator<Audi> orderByComparator)
		throws NoSuchAudiException {
		exteriorColor = Objects.toString(exteriorColor, "");
		...
		try {
			...
			array[0] = getByexteriorColor_PrevAndNext(session, audi,
					exteriorColor, orderByComparator, true);

			array[1] = audi;

			array[2] = getByexteriorColor_PrevAndNext(session, audi,
					exteriorColor, orderByComparator, false);
	...
	protected Audi getByexteriorColor_PrevAndNext(Session session, Audi audi,
		String exteriorColor, OrderByComparator<Audi> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByexteriorColor(String exteriorColor) {
		for (Audi audi : findByexteriorColor(exteriorColor, QueryUtil.ALL_POS,
				QueryUtil.ALL_POS, null)) {
			remove(audi);
		}
	}
	...
	public int countByexteriorColor(String exteriorColor) {
		...
		Object[] finderArgs = new Object[] { exteriorColor };
	...
	public void cacheResult(Audi audi) {
		entityCache.putResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiImpl.class, audi.getPrimaryKey(), audi);

		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G,
			new Object[] { audi.getUuid(), audi.getGroupId() }, audi);
	...
	public void cacheResult(List<Audi> audis) {
		for (Audi audi : audis) {
			if (entityCache.getResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
						AudiImpl.class, audi.getPrimaryKey()) == null) {
				cacheResult(audi);
			}
			else {
				audi.resetOriginalValues();
	...
	public void clearCache(Audi audi) {
		entityCache.removeResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiImpl.class, audi.getPrimaryKey());
	...
	protected void cacheUniqueFindersCache(AudiModelImpl audiModelImpl) {
		Object[] args = new Object[] {
				audiModelImpl.getUuid(), audiModelImpl.getGroupId()
			};

		finderCache.putResult(FINDER_PATH_COUNT_BY_UUID_G, args,
			Long.valueOf(1), false);
		finderCache.putResult(FINDER_PATH_FETCH_BY_UUID_G, args, audiModelImpl,
			false);
	}

	protected void clearUniqueFindersCache(AudiModelImpl audiModelImpl,
	 ...
	 * Removes the audi with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param primaryKey the primary key of the audi
	 * @return the audi that was removed
	 * @throws NoSuchAudiException if a audi with the primary key could not be found
	 */
	@Override
	public Audi remove(Serializable primaryKey) throws NoSuchAudiException {
		...
		try {
			...
			if (audi == null) {
				...
				throw new NoSuchAudiException(_NO_SUCH_ENTITY_WITH_PRIMARY_KEY +
					primaryKey);
			}
	...
	public Audi updateImpl(Audi audi) {
		...
		if (!(audi instanceof AudiModelImpl)) {
			...
			if (ProxyUtil.isProxyClass(audi.getClass())) {
				...
				throw new IllegalArgumentException(
					"Implement ModelWrapper in audi proxy " +
					invocationHandler.getClass());
			}

			throw new IllegalArgumentException(
				"Implement ModelWrapper in custom Audi implementation " +
				audi.getClass());
		}
		...
		if (!AudiModelImpl.COLUMN_BITMASK_ENABLED) {
		 ...
		 if (isNew) {
			Object[] args = new Object[] { audiModelImpl.getUuid() };
			...
			args = new Object[] {
					audiModelImpl.getUuid(), audiModelImpl.getCompanyId()
				};
			...
			args = new Object[] { audiModelImpl.getModelName() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_MODELNAME, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_MODELNAME,
				args);

			args = new Object[] { audiModelImpl.getExteriorColor() };

			finderCache.removeResult(FINDER_PATH_COUNT_BY_EXTERIORCOLOR, args);
			finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_EXTERIORCOLOR,
				args);
			...
			if ((audiModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] { audiModelImpl.getOriginalUuid() };

				finderCache.removeResult(FINDER_PATH_COUNT_BY_UUID, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_UUID,
					args);

				args = new Object[] { audiModelImpl.getUuid() };
			...
			if ((audiModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
						audiModelImpl.getOriginalModelName()
					};
			...
			if ((audiModelImpl.getColumnBitmask() &
				...
				finderCache.removeResult(FINDER_PATH_COUNT_BY_EXTERIORCOLOR,
					args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_EXTERIORCOLOR,
					args);
		...
		entityCache.putResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
			AudiImpl.class, audi.getPrimaryKey(), audi, false);
	...
	/**
	 * Returns the audi with the primary key or throws a {@link com.liferay.portal.kernel.exception.NoSuchModelException} if it could not be found.
	 *
	 * @param primaryKey the primary key of the audi
	 * @return the audi
	 * @throws NoSuchAudiException if a audi with the primary key could not be found
	 */
	@Override
	public Audi findByPrimaryKey(Serializable primaryKey)
		throws NoSuchAudiException {
	...
	public Audi fetchByPrimaryKey(Serializable primaryKey) {
		Serializable serializable = entityCache.getResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
				AudiImpl.class, primaryKey);
		...
		if (audi == null) {
			...
			try {
				...
				if (audi != null) {
					...
					entityCache.putResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
						AudiImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception e) {
				entityCache.removeResult(AudiModelImpl.ENTITY_CACHE_ENABLED,
	...
	@Override
	public Map<Serializable, Audi> fetchByPrimaryKeys(
