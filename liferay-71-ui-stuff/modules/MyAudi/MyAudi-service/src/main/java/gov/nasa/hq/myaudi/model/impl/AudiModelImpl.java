...
/**
 * The base model implementation for the Audi service. Represents a row in the &quot;myaudi_Audi&quot;
 * database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link AudiModel} exist only as a container for the
 * default property accessors generated by ServiceBuilder. Helper methods and all application logic should be
 * put in {@link AudiImpl}.
 * </p>
 *
...
public class AudiModelImpl extends BaseModelImpl<Audi> implements AudiModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a audi model instance should use
     * the {@link Audi} interface instead.
     */
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(gov.nasa.hq.myaudi.service.util.ServiceProps
            .get("value.object.entity.cache.enabled.gov.nasa.hq.myaudi.model.Audi"), true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(gov.nasa.hq.myaudi.service.util.ServiceProps
            .get("value.object.finder.cache.enabled.gov.nasa.hq.myaudi.model.Audi"), true);
    public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(gov.nasa.hq.myaudi.service.util.ServiceProps
            .get("value.object.column.bitmask.enabled.gov.nasa.hq.myaudi.model.Audi"), true);
    public static final long ALLWHEELDRIVE_COLUMN_BITMASK = 1L;
    public static final long COMPANYID_COLUMN_BITMASK = 2L;
    public static final long EXTERIORCOLOR_COLUMN_BITMASK = 4L;
    ...
    public static final long LOCK_EXPIRATION_TIME = GetterUtil
            .getLong(gov.nasa.hq.myaudi.service.util.ServiceProps.get("lock.expiration.time.gov.nasa.hq.myaudi.model.Audi"));
    ...
    public void setAllWheelDrive(boolean allWheelDrive) {
        _columnBitmask |= ALLWHEELDRIVE_COLUMN_BITMASK;

        if (!_setOriginalAllWheelDrive) {
            _setOriginalAllWheelDrive = true;

            _originalAllWheelDrive = _allWheelDrive;
        }

        _allWheelDrive = allWheelDrive;
    }

    public boolean getOriginalAllWheelDrive() {
        return _originalAllWheelDrive;
    }
    ...
    public StagedModelType getStagedModelType() {
        return new StagedModelType(PortalUtil.getClassNameId(Audi.class.getName()));
    }
    ...
    public ExpandoBridge getExpandoBridge() {
        return ExpandoBridgeFactoryUtil.getExpandoBridge(getCompanyId(), Audi.class.getName(), getPrimaryKey());
    }
    ...
    public Audi toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (Audi) ProxyUtil.newProxyInstance(_classLoader, _escapedModelInterfaces,
    ...
    public void resetOriginalValues() {
        ...
        audiModelImpl._originalAllWheelDrive = audiModelImpl._allWheelDrive;

        audiModelImpl._setOriginalAllWheelDrive = false;
    ...
    public String toXmlString() {
        ...
        sb.append("<column><column-name>audiId</column-name><column-value><![CDATA[");
        sb.append(getAudiId());
        sb.append("]]></column-value></column>");
        ...
        sb.append(getModifiedDate());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>modelName</column-name><column-value><![CDATA[");
        sb.append(getModelName());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>exteriorColor</column-name><column-value><![CDATA[");
        sb.append(getExteriorColor());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>interiorColor</column-name><column-value><![CDATA[");
        sb.append(getInteriorColor());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>allWheelDrive</column-name><column-value><![CDATA[");
        sb.append(isAllWheelDrive());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>technologyPackage</column-name><column-value><![CDATA[");
        sb.append(isTechnologyPackage());
        sb.append("]]></column-value></column>");
        sb.append("<column><column-name>coldWeatherPackage</column-name><column-value><![CDATA[");
        sb.append(isColdWeatherPackage());
        sb.append("]]></column-value></column>");
    ...
    private boolean _originalAllWheelDrive;
    private boolean _setOriginalAllWheelDrive;
