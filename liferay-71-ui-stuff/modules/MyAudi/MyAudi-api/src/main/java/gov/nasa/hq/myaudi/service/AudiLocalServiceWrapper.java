 ...
 */
@ProviderType
public class AudiLocalServiceWrapper implements AudiLocalService, ServiceWrapper<AudiLocalService> {
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi addAudi(gov.nasa.hq.myaudi.model.Audi audi) {
        return _audiLocalService.addAudi(audi);
    }

    @Override
    public gov.nasa.hq.myaudi.model.Audi addAudi(com.liferay.portal.kernel.model.User user, String modelName,
            String exteriorColor, String interiorColor, Boolean allWheelDrive, Boolean coldWeatherPackage,
            Boolean technologyPackage) {
        return _audiLocalService.addAudi(user, modelName, exteriorColor, interiorColor, allWheelDrive, coldWeatherPackage,
                technologyPackage);
    }
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi deleteAudi(gov.nasa.hq.myaudi.model.Audi audi) {
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi deleteAudi(long audiId) throws com.liferay.portal.kernel.exception.PortalException {
    ...
    public <T> java.util.List<T> dynamicQuery(com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery, int start,
        ...
        return _audiLocalService.dynamicQuery(dynamicQuery, start, end, orderByComparator);
    }
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi fetchAudiByUuidAndGroupId(String uuid, long groupId) {
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi getAudi(long audiId) throws com.liferay.portal.kernel.exception.PortalException {
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi getAudiByUuidAndGroupId(String uuid, long groupId)
            throws com.liferay.portal.kernel.exception.PortalException {
     ...
     */
    @Override
    public java.util.List<gov.nasa.hq.myaudi.model.Audi> getAudis(int start, int end) {
     ...
     */
    @Override
    public java.util.List<gov.nasa.hq.myaudi.model.Audi> getAudisByUuidAndCompanyId(String uuid, long companyId) {
     ...
     */
    @Override
    public java.util.List<gov.nasa.hq.myaudi.model.Audi> getAudisByUuidAndCompanyId(String uuid, long companyId, int start,
            int end, com.liferay.portal.kernel.util.OrderByComparator<gov.nasa.hq.myaudi.model.Audi> orderByComparator) {
        return _audiLocalService.getAudisByUuidAndCompanyId(uuid, companyId, start, end, orderByComparator);
    }
     ...
     */
    @Override
    public gov.nasa.hq.myaudi.model.Audi updateAudi(gov.nasa.hq.myaudi.model.Audi audi) {
        return _audiLocalService.updateAudi(audi);
    }

    @Override
    public gov.nasa.hq.myaudi.model.Audi updateAudi(com.liferay.portal.kernel.model.User user, long audiId, String modelName,
            String exteriorColor, String interiorColor, Boolean allWheelDrive, Boolean coldWeatherPackage,
            Boolean technologyPackage) throws com.liferay.portal.kernel.exception.PortalException {
        return _audiLocalService.updateAudi(user, audiId, modelName, exteriorColor, interiorColor, allWheelDrive,
