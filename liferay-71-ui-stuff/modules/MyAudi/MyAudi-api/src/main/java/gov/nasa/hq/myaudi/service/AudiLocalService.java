...
/**
 * Provides the local service interface for Audi. Methods of this
...
public interface AudiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AudiLocalServiceUtil} to access the audi local service. Add custom service methods to {@link gov.nasa.hq.myaudi.service.impl.AudiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public Audi addAudi(User user, String modelName, String exteriorColor,
		String interiorColor, Boolean allWheelDrive,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Audi getAudiByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	...
	*/
	...
	public Audi updateAudi(User user, long audiId, String modelName,
		String exteriorColor, String interiorColor, Boolean allWheelDrive,
		Boolean coldWeatherPackage, Boolean technologyPackage)
		throws SystemException, PortalException;
}