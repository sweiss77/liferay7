...
/**
 * Provides the local service interface for Audi. Methods of this service will not have security checks based
 * on the propagated JAAS credentials because this service can only be accessed from within the same VM.
 *
 * @author Brian Wing Shun Chan
 * @see AudiLocalServiceUtil
...
public interface AudiLocalService extends BaseLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AudiLocalServiceUtil} to access
     * the audi local service. Add custom service methods to {@link
     * gov.nasa.hq.myaudi.service.impl.AudiLocalServiceImpl} and rerun ServiceBuilder to automatically copy
    ...
    public Audi createAudi(long audiId);
    ...
    public Audi deleteAudi(Audi audi);
     ...
     */
    @Indexable(type = IndexableType.DELETE)
    public Audi deleteAudi(long audiId) throws PortalException;
    ...
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public Audi fetchAudi(long audiId);
     ...
     */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public Audi fetchAudiByUuidAndGroupId(String uuid, long groupId);
     ...
     */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public Audi getAudi(long audiId) throws PortalException;
     ...
     */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public Audi getAudiByUuidAndGroupId(String uuid, long groupId) throws PortalException;
     ...
     */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<Audi> getAudis(int start, int end);
     ...
     */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<Audi> getAudisByUuidAndCompanyId(String uuid, long companyId);
     ...
     */
    @Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
    public List<Audi> getAudisByUuidAndCompanyId(String uuid, long companyId, int start, int end,
