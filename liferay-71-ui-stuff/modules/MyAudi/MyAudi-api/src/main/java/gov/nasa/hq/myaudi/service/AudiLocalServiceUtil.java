 ...
 * {@link gov.nasa.hq.myaudi.service.impl.AudiLocalServiceImpl} and is the primary access point for service
 * operations in application layer code running on the local server. Methods of this service will not have
 * security checks based on the propagated JAAS credentials because this service can only be accessed from
 * within the same VM.
 *
...
public class AudiLocalServiceUtil {
     ...
     * gov.nasa.hq.myaudi.service.impl.AudiLocalServiceImpl} and rerun ServiceBuilder to regenerate this
     * class.
     */
     ...
     */
    public static gov.nasa.hq.myaudi.model.Audi addAudi(gov.nasa.hq.myaudi.model.Audi audi) {
        return getService().addAudi(audi);
    }

    public static gov.nasa.hq.myaudi.model.Audi addAudi(com.liferay.portal.kernel.model.User user, String modelName,
            String exteriorColor, String interiorColor, Boolean allWheelDrive, Boolean coldWeatherPackage,
            Boolean technologyPackage) {
        return getService().addAudi(user, modelName, exteriorColor, interiorColor, allWheelDrive, coldWeatherPackage,
                technologyPackage);
    }
     ...
     */
    public static gov.nasa.hq.myaudi.model.Audi deleteAudi(gov.nasa.hq.myaudi.model.Audi audi) {
     ...
     * <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full
     * result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER
     * BY logic. If <code>orderByComparator</code> is absent and pagination is required (<code>start</code>
     * and <code>end</code> are not {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS}), then the
     * query will include the default ORDER BY logic from {@link gov.nasa.hq.myaudi.model.impl.AudiModelImpl}.
     * If both <code>orderByComparator</code> and pagination are absent, for performance reasons, the query
     * will not have an ORDER BY clause and the returned result set will be sorted on by the primary key in an
     * ascending order.
     * </p>
     *
     * @param dynamicQuery
     ...
     */
    public static <T> java.util.List<T> dynamicQuery(com.liferay.portal.kernel.dao.orm.DynamicQuery dynamicQuery, int start,
            int end) {
     ...
     */
    public static gov.nasa.hq.myaudi.model.Audi fetchAudiByUuidAndGroupId(String uuid, long groupId) {
     ...
     */
    public static gov.nasa.hq.myaudi.model.Audi getAudiByUuidAndGroupId(String uuid, long groupId)
            throws com.liferay.portal.kernel.exception.PortalException {
     ...
     */
    public static java.util.List<gov.nasa.hq.myaudi.model.Audi> getAudis(int start, int end) {
     ...
     *
     * @param uuid
     *            the UUID of the audis
     * @param companyId
     *            the primary key of the company
     * @return the matching audis, or an empty list if no matches were found
     */
    public static java.util.List<gov.nasa.hq.myaudi.model.Audi> getAudisByUuidAndCompanyId(String uuid, long companyId) {
    ...
    public static java.util.List<gov.nasa.hq.myaudi.model.Audi> getAudisByUuidAndCompanyId(String uuid, long companyId,
        ...
        return getService().getAudisByUuidAndCompanyId(uuid, companyId, start, end, orderByComparator);
    }
    ...
    /**
     * Updates the audi in the database or adds it if it does not yet exist. Also notifies the appropriate
     * model listeners.
     *
     * @param audi
     *            the audi
     ...
     */
    public static gov.nasa.hq.myaudi.model.Audi updateAudi(gov.nasa.hq.myaudi.model.Audi audi) {
        return getService().updateAudi(audi);
    }

    public static gov.nasa.hq.myaudi.model.Audi updateAudi(com.liferay.portal.kernel.model.User user, long audiId,
            String modelName, String exteriorColor, String interiorColor, Boolean allWheelDrive, Boolean coldWeatherPackage,
            Boolean technologyPackage) throws com.liferay.portal.kernel.exception.PortalException {
        return getService().updateAudi(user, audiId, modelName, exteriorColor, interiorColor, allWheelDrive,
                coldWeatherPackage, technologyPackage);
    }
    ...
    static {
        Bundle bundle = FrameworkUtil.getBundle(AudiLocalService.class);

        ServiceTracker<AudiLocalService, AudiLocalService> serviceTracker = new ServiceTracker<AudiLocalService, AudiLocalService>(
                bundle.getBundleContext(), AudiLocalService.class, null);
