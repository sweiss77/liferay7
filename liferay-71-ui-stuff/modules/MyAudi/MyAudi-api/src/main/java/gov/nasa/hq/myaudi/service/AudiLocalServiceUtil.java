...
public class AudiLocalServiceUtil {
	...
	*/
	...
	public static gov.nasa.hq.myaudi.model.Audi addAudi(
		com.liferay.portal.kernel.model.User user, String modelName,
	...
	*/
	...
	public static gov.nasa.hq.myaudi.model.Audi updateAudi(
		...
		String modelName, String exteriorColor, String interiorColor,
		Boolean allWheelDrive, Boolean coldWeatherPackage,
	...
	static {
		...
		ServiceTracker<AudiLocalService, AudiLocalService> serviceTracker = new ServiceTracker<AudiLocalService, AudiLocalService>(bundle.getBundleContext(),
				AudiLocalService.class, null);
